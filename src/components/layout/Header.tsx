  ...
  return (
    <header
      className={cn(
        ...
        scrolled
          ? "bg-background/80 backdrop-blur-xl border-b border-radio-white/10 shadow-lg"
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={cn(
                  ...
                  isActive(link.href)
                    ? "text-secondary"
                    : "text-radio-navy/75 hover:text-radio-navy dark:text-radio-white/70 dark:hover:text-radio-white",
                )}
              >
                {link.label}
                {isActive(link.href) && (
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link
              to="/login"
              className="inline-flex items-center gap-2 text-sm text-radio-navy/75 hover:text-radio-navy dark:text-radio-white/75 dark:hover:text-radio-white transition-colors"
            >
          ...
          <div className="md:hidden flex items-center gap-2">
            <button
              className="p-2 text-radio-navy dark:text-radio-white"
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-radio-white/10 animate-fade-in">
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive(link.href)
                      ...
                      : "text-radio-navy/80 hover:bg-radio-navy/5 dark:text-radio-white/80 dark:hover:bg-radio-white/5",
                  )}
                >
                  {link.label}
                </Link>
